...
public class Usuarios2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewUsuarios.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(getApplicationContext(), TesteVeterinarioActivity.class);
    ...
    protected void onStart() {
        ...
        databaseUsuarios.child("usuarios").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                UsuarioList adapter = new UsuarioList(Usuarios2Activity.this, usuarioList);
                if(adapter.getCount()!=0){
                    listViewUsuarios.setAdapter(adapter);
                }else{
                    Toast.makeText(Usuarios2Activity.this, "Não existem usuarios cadastrados",Toast.LENGTH_SHORT).show();
                }
