...
public class AnimaisVeterinarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_animais_veterinario);
        ...
        String id = intent.getStringExtra(UsuariosActivity.USUARIO_ID);
        String name = intent.getStringExtra(UsuariosActivity.USUARIO_NAME);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(AnimaisVeterinarioActivity.this));
        // Assign activity this to progress dialog.
        progressDialog = new ProgressDialog(AnimaisVeterinarioActivity.this);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                adapter = new RecyclerAdapter3(getApplicationContext(), list);
                if(adapter.getItemCount()!=0){
                    recyclerView.setAdapter(adapter);
                }else{
                    Toast.makeText(AnimaisVeterinarioActivity.this, "Não existem animais cadastrados",Toast.LENGTH_SHORT).show();
                }
