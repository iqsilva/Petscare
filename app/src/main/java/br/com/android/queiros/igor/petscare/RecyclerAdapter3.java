...
public class RecyclerAdapter3 extends RecyclerView.Adapter<RecyclerViewHolder>{
    ...
    public RecyclerAdapter3(Context context, List<ImageUploadInfo> mainImageUploadInfoList) {
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.recyclerview_items3, parent, false);
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, int position) {
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int position, boolean isLongClick) {
                ...
                {
                    Intent intent = new Intent(context, PerfilAnimalVeterinarioActivity.class);
