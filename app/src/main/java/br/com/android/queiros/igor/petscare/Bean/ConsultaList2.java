...
public class ConsultaList2 extends ArrayAdapter<Consulta> {
    private Activity context;
    List<Consulta> consultas;

    public ConsultaList2(Activity context, List<Consulta> consultas) {
        super(context, R.layout.list_layout_consulta_veterinario, consultas);
