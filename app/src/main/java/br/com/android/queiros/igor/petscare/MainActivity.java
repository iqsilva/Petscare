...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_animais) {
            ...
            Intent tela = new Intent(this, DisplayImagesActivity.class);
            startActivityForResult( tela, 1 );

        }else if (id == R.id.nav__cadastro_animais) {

            Intent tela = new Intent(this, CadastroAnimaisActivity.class);
            startActivityForResult( tela, 1 );

        }else if (id == R.id.nav_consultas) {
            Intent tela = new Intent(this, TesteActivity.class);
            startActivityForResult( tela, 1 );

        }else if (id == R.id.nav_contato) {
            Intent tela = new Intent(this, ContatoActivity.class);
            startActivityForResult( tela, 1 );
