...
public class ProcedimentoList2 extends ArrayAdapter<Procedimento> {
    private Activity context;
    List<Procedimento> procedimentos;

    public ProcedimentoList2(Activity context, List<Procedimento> procedimentos) {
        super(context, R.layout.list_layout_procedimentos_veterinario, procedimentos);
