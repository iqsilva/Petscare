...
public class RecyclerAdapter2 extends RecyclerView.Adapter<RecyclerViewHolder>{
    ...
    public RecyclerAdapter2(Context context, List<ImageUploadInfo> mainImageUploadInfoList) {
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.recyclerview_items2, parent, false);
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, int position) {
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int position, boolean isLongClick) {
                ...
                {
                    Intent intent = new Intent(context, ConsultasActivity.class);
