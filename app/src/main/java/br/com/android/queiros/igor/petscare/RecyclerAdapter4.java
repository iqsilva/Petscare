...
class RecyclerViewHolder4 extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnLongClickListener
{
    ...
    public RecyclerViewHolder4(View view) {
        super(view);
...
public class RecyclerAdapter4 extends RecyclerView.Adapter<RecyclerViewHolder>{
    ...
    public RecyclerAdapter4(Context context, List<ImageUploadInfo> mainImageUploadInfoList) {
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.recyclerview_items4, parent, false);
    ...
    public void onBindViewHolder(final RecyclerViewHolder holder, int position) {
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int position, boolean isLongClick) {
                ...
                {
                    Intent intent = new Intent(context, AnimaisConsultasVeterinarioActivity.class);
